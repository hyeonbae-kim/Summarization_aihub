...
DATASET=report
SUB_DATASET="news briefing hiscul paper minute edit public speech literature narration"
...
RAW_PATH="../json_data/${DATASET}"
SAVE_PATH="../bert_data/${DATASET}"
mkdir -p ${SAVE_PATH}
python -m preprocess \
	-mode format_to_bert \
	-raw_path $RAW_PATH \
