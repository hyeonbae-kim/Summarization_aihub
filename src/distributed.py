...
def all_reduce_and_rescale_tensors(tensors, rescale_denom,
    ...
    filled = 0
    for t in tensors:
        def_logger.debug(f'all_reduce_and_rescale_tensors t.shape: {t.shape}, t: {t}')
...
def all_gather_list(data, max_size=4096):
    ...
    def_logger.debug(f'all_gather_list data: {data}, results: {results}')
    return results
