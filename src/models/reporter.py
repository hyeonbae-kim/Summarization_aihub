...
class Statistics(object):
    ...
    * elapsed time
    ...
    def __repr__(self):
        return f"loss: {self.loss}, n_words: {self.n_words}, n_docs: {self.n_docs}, n_correct: {self.n_correct}, n_src_words: {self.n_src_words}, start_time: {self.start_time}"
